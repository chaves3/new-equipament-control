...
$pegarTodosId = \Models\CalibracaoModel::pegarTodosEquipamentosId($id);

foreach ($pegarTodosId as $key => $value) {
...
<section class="emprestimo-form">
    <div class="container">
        <div class="box">
            <h2>Editar Equipamento <?php print($_SESSION['nome']); ?> <i class="bi bi-pen-fill"></i> </h2>
            ...
            <div class="input-group ">
                ...
                <div class="form-floating">
                    <input type="text" name="equip" class="form-control" id="equipa" value="<?php print($value['equi']); ?>" placeholder="Equipamento">
            ...
            <div class="input-group">
                ...
                <div class="form-floating">
                    <input type="text" name="ativo" class="form-control" id="ativo1"  value="<?php print($value['act']); ?>" placeholder="Ativo">
            ...
            <div class="input-group ">
                ...
                <div class="form-floating">
                    <input type="text" name="cod" class="form-control" id="cod"  value="<?php print($value['cod_calibracao']); ?>" placeholder="Equipamento">
            ...
            <div class="input-group">
                ...
                <div class="form-floating">
                    <input type="date" name="data_calibracao" class="form-control" id="data_calibracao"  value="<?php print($value['data_calibracao']); ?>" placeholder="Data de Calibração">
            ...
            <div class="input-group">
                ...
                <div class="form-floating">
                    ...
                    <input type="hidden" name="cert_atual" class="form-control" id="cert_atual" value="<?php print($value['certificado']) ?>" accept="application/pdf" >
            ...
            <div class="input-group">
                ...
                <div class="form-floating">
                <textarea name="obs" class="form-control" id="obs"> <?php print($value['obs']); ?></textarea>
            ...
            <div class="input-group">
                ...
                <select class="form-select" name="status"   aria-label="Default select example">
                    <option selected value="<?php print($value['status']); ?>"><?php print($value['status']); ?></option>
            ...
            <div class="input-group mb-3">
                <button type="submit" name="acao" class="btn btn-dark mb-3 emprestar">Editar</button>
                </div>
            </div>
            </form>
